...
class RastDSL
  ...
  def initialize(rasted_class, spec_id, &block)
  ...
  def execute(&block)
    ...
    fixtures = param_generator.generate_data(yaml_path: yaml_path, id: @id)
...
# DSL Entry Point
def rast(rasted_class, spec: '', &block)
  RastDSL.new(rasted_class, spec, &block)
end
